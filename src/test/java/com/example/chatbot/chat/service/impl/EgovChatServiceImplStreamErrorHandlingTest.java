 ...
 * {@link com.example.chatbot.chat.repository.PersistentChatMemoryStore}를 통해 세션 히스토리를
...
class EgovChatServiceImplStreamErrorHandlingTest {
    ...
    private final EgovChatServiceImpl service =
            new EgovChatServiceImpl(mock(com.example.chatbot.chat.service.ChatbotFactory.class),
                    mock(com.example.chatbot.chat.service.PendingImageStore.class),
                    java.util.Optional.of(mock(com.example.chatbot.sqlgen.service.SqlGenService.class)));
