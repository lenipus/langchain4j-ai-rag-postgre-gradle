...
/**
 * {@code sqlgen.enabled=false}면 {@link com.example.chatbot.sqlgen.service.impl.SqlGenServiceImpl} 빈
...
class EgovChatServiceImplSqlGenDisabledTest {
    ...
    private final EgovChatServiceImpl service =
            new EgovChatServiceImpl(mock(com.example.chatbot.chat.service.ChatbotFactory.class),
                    mock(com.example.chatbot.chat.service.PendingImageStore.class), Optional.empty());
