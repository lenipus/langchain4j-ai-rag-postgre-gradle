package com.example.chatbot.chat.util;

/*
import com.google.gson.Gson;
import com.example.chatbot.chat.config.EgovEmbeddingConfig;
 ...
 *
 * 임베딩을 Ollama 원격 서버 방식으로 전환하면서 더 이상 사용되지 않아 전체 주석 처리함.
 * (ONNX 설정 파일 경로 로딩용 유틸리티였음)
 *
@Slf4j
@Component
