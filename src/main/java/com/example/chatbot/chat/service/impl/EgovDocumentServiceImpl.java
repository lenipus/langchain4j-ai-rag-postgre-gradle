...
import com.example.chatbot.chat.config.etl.readers.EgovDocumentScanner;
import com.example.chatbot.chat.config.etl.transformers.EgovContentFormatTransformer;
import com.example.chatbot.chat.config.etl.transformers.EgovEnhancedDocumentTransformer;
import com.example.chatbot.chat.config.etl.writers.EgovVectorStoreWriter;
import com.example.chatbot.chat.entity.DocumentHashEntity;
import com.example.chatbot.chat.repository.DocumentHashRepository;
import com.example.chatbot.chat.response.DocumentStatusResponse;
import com.example.chatbot.chat.service.EgovDocumentService;
import com.example.chatbot.chat.util.DocumentHashUtil;
...
public class EgovDocumentServiceImpl extends EgovAbstractServiceImpl implements EgovDocumentService {
     ...
     * {@link com.example.chatbot.chat.config.etl.readers.EgovDocumentScanner}가 파싱 없이
